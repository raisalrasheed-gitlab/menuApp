...
const Footer = () => {
  return (
    <>
      <div className="xls:h-[250px] bg-black grid xl:grid-cols-3 justify-center items-center justify-items-center gap-4">
        ...
        <div className="w-[330px] h-[128px] md:w-[373px] md:h-[134px]  border-2 border-white rounded-2xl order-1 md:order-2 justify-center flex flex-col items-center relative">
